...
-   сохранение заметок;
-   удаление заметок;
-   присвоение заметкам тегов и поиск заметок по тегам;
...
В следующих версиях приложения можно реализовать:

- экспорт заметок в TXT и PDF;
- поиск по содержимому заметок;
- автоматическое резервное копирование;
- сортировку по дате создания и изменения;
- синхронизацию между устройствами;
- хранение заметок в базе данных SQLite.
